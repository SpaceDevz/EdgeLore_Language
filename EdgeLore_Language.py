...
DATA2BASES = "MULTIPLE SETS OF INTERFACED INFORMATION THAT IS STRUCTURED IN A STORAGE BANK FOR ACCESS IN VARIOUS WAYS"
...
ACCOUNT = "PERSONAL INTERFACE AND OR ARRANGEMENT OF INFORMATION AND OR A DATA2BASE OF INFORMATION ON A INTERFACE"
...
PLAYEREXPERIENCE = "KNOWLEDGE2 OR SKILL AQUIRED OVER TIME"
...
CHAKRA = "COMBINATION OF USING THE AURA SPIRIT SOUL MIND AND OR BODY TO PRODUCE VISIBLE ENERGY THAT ALLOWS A NEW COMMAND TO BE GIVEN FROM A CHOSEN KNOWN SEAL THAT IS INSIDE THAT MIND DATA2BASE OF COLLECTION OF COMMANDS AND SEALS BASED ON THE UNCONDITIONAL LOVE FAITH AND BELIEF OF THAT HUMAN COMBINED WITH HIS AND OR HER SPIRITUALITY"
POINT = "DESTINATION"
...
DATA2BASE2 = "COLLECTION OF DEFINED DATA2 UNITS AND OR CELLS AND OR BITS AND OR BYTES"
...
DATA2BASE = "A CONTAINER FOR AN ENTIRE CATEGORY OF SPECIFIED DATA2 OR DATA2 TWO"
...
IDENTICAL = "SIMILAR BUT NOT EXACT SAME COPY OF CLONE VALUE USING INFORMATION FROM DATA2BASE SYSTEMS OF MULTI EXTREME NETWORKS OF INFORMATION VALUES WITHIN VISUAL VALUES USING AN INTERFACE SYSTEM"
...
MOLD = "FORM EFFECT USING A CREATION VALUE AND DIMENSIONAL MEASUREMENT USING VERTICLE AND HORIZONTAL AXIS POINTS OF GRAPHIC PROPERTY PIXELS IN VALUE OF ASPECT A CREATED SYSTEM OF DATA2 INSIDE DATA2BASE2"
...
ADDITION = "PLUS ONE MULTI OF MULTIPLE MULTI FORMULAS GIVEN ONE MULTI TABLE OF DIMENSIONAL VALUES STATED BY VECTOR GRAPHIC POINTS INSIDE TIME TO PRODUCE A TWO DIMENSION CHART WITH ALL DATA2 ON A TABLE AS A PLANE OF EXISTENCE"
...
DATA2BANK = "A BANK OF DATA2 INFORMATION TO USE IN LIFE DATA2"
